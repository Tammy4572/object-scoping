...
**************************************************************************************/
// var x will print out after scopeThis() but var y will not print out at all.
...
**************************************************************************************/
//What would console.log(x) and console.log(foo) print? Why?
//console.log(x); would print out as undefined
//console.log(foo); would print out "function hoising" because of hoisting
...
**************************************************************************************/
// console.log(add) (inside the IFEE) will print the result of add
// console.log(add) (outside the IFEE) will print undefined
...
(function(){
  "use strict";
  var date = new Date("April 21, 1983 01:15:00");
  var birthday = date.setDate(21);
...
(function(){
  ...
  console.assert(pizza.pizzaMkr() == "We are making your pizza with tomato and chicken. Pickup in 20 minutes.", "#7 Test failed.")
})();
